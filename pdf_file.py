...
def download_pdf_report():
    ...
    signature_path = r"C:\Users\Franco Gian Ramos\PycharmProjects\pythonProject8\anadol.png"
    ...
    signature_image = Image(signature_path, width=150, height=70)
